package net.mcgooglesss.tutorialmod;

import net.mcgooglesss.tutorialmod.block.ModBlocks;
import net.mcgooglesss.tutorialmod.item.ModItems;
...
public class TutorialMod {
    public static final String MOD_ID = "mcgtutorialmod";
